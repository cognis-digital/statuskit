...
[![PyPI](https://img.shields.io/pypi/v/cognis-statuskit.svg)](https://pypi.org/project/cognis-statuskit/)
[![CI](https://github.com/cognis-digital/statuskit/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/statuskit/actions)
...
STATUSKIT exists for one job — self-hosted status page with incident timeline and subscribers — and does it without a SaaS bill or heavyweight setup.
...
```bash
statuskit --version
statuskit scan .                      # scan the current project
statuskit scan . --format json
statuskit scan . --fail-on high       # non-zero exit for CI gates
statuskit mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **Statuspal / Cachet**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`statuskit` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
