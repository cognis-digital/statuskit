"""Native cognis-connect emit for statuskit — forward findings to any platform.

Maps statuskit's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    statuskit ... --format json | statuskit-emit --to stix
    statuskit-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
