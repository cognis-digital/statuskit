"""STATUSKIT core — Self-hosted status page with incident timeline and subscribers."""
...
RULES = [
    ("STA-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("STA-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("STA-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
