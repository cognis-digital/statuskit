#!/usr/bin/env sh
# Universal installer for statuskit. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/statuskit.git"
echo "Installing statuskit ..."
